...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterial.SCUTE_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 100, 1,
                                    false, false)))

                    .put(ModArmorMaterial.REINFORCED_SCUTE_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 100, 2,
                                    false, false),
                                    new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 100, 2,
                                            false, false)))

                    .put(ModArmorMaterial.HARDENED_SCUTE_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 100, 2,
                                            false, false),
                                    new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 100, 3,
                                            false, false),
                                    new StatusEffectInstance(StatusEffects.HASTE, 100, 3,
                                            false, false)))
                    .build();
